...
| 2     | The two park rows of storage anomalies run for real    | sonnet | `go test ./cmd/frit -run 'TestFeatures/S(40\|78):'` passes with no SKIP; the bijection gate stays green; `go test ./...` and golangci-lint clean                 |
| 3     | The two CAS/TRUST rows S67 and S68 run for real        | sonnet | `go test ./cmd/frit -run 'TestFeatures/S(67\|68):'` passes with no SKIP; the bijection gate stays green; `go test ./...` and golangci-lint clean                 |
