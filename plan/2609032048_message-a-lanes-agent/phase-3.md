...
place. Plan 2609031951 took S90 after this plan was written, so S91 is
the next free cross-layer id. Phase 2's handoff names the exact state
to reproduce.
...
unlanded. Add a `@S91` scenario to
...
Write the handoff to `phase-3.result.md`. Confirm S91 is live and the
